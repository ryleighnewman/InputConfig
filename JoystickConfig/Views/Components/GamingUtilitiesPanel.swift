...
struct GamingUtilitiesPanel: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            Text("These are global defaults used when a preset doesn't set its own. Per-preset overrides live in the preset editor's Automation panel - that's the right place for game-specific choices. Nothing here changes macOS-wide settings.")
                .font(.caption)
