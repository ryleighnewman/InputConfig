...
/// Per-preset Automation panel for the preset editor. Houses settings
/// that should ride along with each preset rather than living in
/// global app Settings - because what makes sense for, say, a
/// Counter-Strike preset (confine cursor, hide cursor, auto-launch
/// Steam) is exactly wrong for a desktop-productivity preset.
///
...
struct PresetAutomationSection: View {
    ...
    private var summaryLine: String {
        ...
        return parts.isEmpty
            ? "No automation set. Expand to add cursor utilities or auto-launch an app."
