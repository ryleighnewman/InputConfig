...
struct TipJarView: View {
    ...
    var body: some View {
        ...
        .alert("Thank you!", isPresented: $showingThanks) {
            ...
            Text("Your support means a lot. JoystickConfig will keep getting better because of it.")
        }
    }
    ...
    private var header: some View {
        VStack(spacing: 6) {
            ...
            Text("Support JoystickConfig")
                .font(.title2.weight(.semibold))
            Text("JoystickConfig is free forever. If it makes your setup better, a tip helps fund continued development.")
                .font(.caption)
...
final class TipJarWindowController {
    ...
    func show() {
        ...
        newWindow.title = "Support JoystickConfig"
