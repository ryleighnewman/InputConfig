...
final class MenuBarController: NSObject, NSMenuDelegate {
    ...
    static let defaultsKey = "JoystickConfig.showMenuBarIcon"
    ...
    func install(presetStore: PresetStore, mappingEngine: MappingEngine,
        ...
        if let button = item.button {
            let image = NSImage(systemSymbolName: "gamecontroller",
                                accessibilityDescription: "JoystickConfig")
    ...
    func menuNeedsUpdate(_ menu: NSMenu) {
        ...
        let open = NSMenuItem(title: "Open JoystickConfig",
        ...
        let tip = NSMenuItem(title: "Support JoystickConfig...",
        ...
        let quit = NSMenuItem(title: "Quit JoystickConfig",
