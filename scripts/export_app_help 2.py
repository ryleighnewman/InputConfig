...
PAGES = [
    ...
    ("help/keyboard-and-mouse-as-input", "Keyboard and Mouse", "Inputs"),
    ...
    ("help/touchpad-regions-and-gestures", "Touchpad Regions", "Inputs"),
    ("help/cursor-and-stick-regions", "Cursor and Stick Regions", "Inputs"),
